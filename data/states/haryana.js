export const haryanaData = {
    hero: {
        ...
        basePath: "/pilot-training-in-haryana",
    },

    menuItems: [
        { name: "Overview", path: "/pilot-training-in-haryana" },
        { name: "Courses", path: "/pilot-training-in-haryana/courses" },
        { name: "Eligibility", path: "/pilot-training-in-haryana/eligibility" },
        { name: "Fees", path: "/pilot-training-in-haryana/fees" },
    ],
    ...
    sections: [
        {
            ...
            paragraphs: [
                "We provide premium aviation training with 100% placement assistance. Our institute has trained more than 3000+ pilots in India with advanced aircraft, modern simulation technology, and experienced instructors.",
            ],
            list: [
                {
                    title: "Certified Training Program",
                    text: "Our academy follows aviation authority regulations to ensure high-quality and standardized pilot training.",
                },
                {
                ...
                },
                {
                    ...
                    text: "Train using Cessna 172 Glass Cockpit aircraft and high-tech simulators for realistic practice.",
                },
                {
                ...
                },
                {
                    ...
                    text: "Strong industry connections to help you get jobs in airlines, charter companies, and cargo operations.",
                },
                {
                    title: "Full Scholarship Opportunities",
                    text: "Flexible fee structure with scholarship support for deserving candidates.",
                },
                {
